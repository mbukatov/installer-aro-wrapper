...
replace (
	...
	github.com/openshift/installer => github.com/mbukatov/installer-aro v0.0.0-20240109185349-cec891abd67c
	...
	github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20240111185711-d7450472821e
