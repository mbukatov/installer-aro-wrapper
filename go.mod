...
replace (
	...
	github.com/metal3-io/baremetal-operator => github.com/openshift/baremetal-operator v0.0.0-20231019133159-8643f32fea3e // Use OpenShift fork
	github.com/metal3-io/baremetal-operator/apis => github.com/openshift/baremetal-operator/apis v0.0.0-20231019133159-8643f32fea3e // Use OpenShift fork
	github.com/metal3-io/baremetal-operator/pkg/hardwareutils => github.com/openshift/baremetal-operator/pkg/hardwareutils v0.0.0-20231019133159-8643f32fea3e // Use OpenShift fork
	...
	github.com/openshift/api => github.com/openshift/api v0.0.0-20231117205818-971e4ba78c9a
	github.com/openshift/assisted-service => github.com/openshift/assisted-service v1.0.10-0.20230907160625-4e1a1e59cef0
	...
	github.com/openshift/installer => github.com/bitoku/installer v0.0.0-20231115050734-1b61ec7d6a77
	...
	github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20231120155809-a6cdd850c44f
